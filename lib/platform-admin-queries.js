...
// Approve an application. For "agent", also bridges into the legacy
// `agents` table so the existing /admin listings dashboard keeps working.
...
// Pull back a previously-approved application. For "agent", also removes
// their row from the legacy `agents` table so they immediately lose
// access to /admin.
